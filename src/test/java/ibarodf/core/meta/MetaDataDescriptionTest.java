...
public class MetaDataDescriptionTest {
	...
	private void testSetter() throws Exception{
		...
		MetaDataDescription metaData = new MetaDataDescription(meta, value1);
		...
		assertEquals(metaData.getAttribut(), MetaDataDescription.attr);
	}
	...
	private void testConstructor() throws Exception{
		...
		MetaDataDescription metaData = new MetaDataDescription(meta, value);
		assertEquals(value, metaData.getValue());
		assertEquals(MetaDataDescription.attr, metaData.getAttribut());
	}
}
