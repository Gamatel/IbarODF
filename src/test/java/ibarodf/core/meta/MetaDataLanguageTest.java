 ...
 */
public class MetaDataLanguageTest {
    /**
     * Rigorous Test :-)
     */
	@Test
	public void testMetaDataLanguageTest () throws Exception {
		testSetter();
		testConstructor();
	}
	...
	private void testSetter() throws Exception{
		...
		MetaDataLanguage metaData = new MetaDataLanguage(meta, value1);
		...
		assertEquals(metaData.getAttribut(), MetaDataLanguage.attr);
	}
	...
	private void testConstructor() throws Exception{
		...
		MetaDataLanguage metaData = new MetaDataLanguage(meta, value);
		assertEquals(value, metaData.getValue());
		assertEquals(MetaDataLanguage.attr, metaData.getAttribut());
	}
}
